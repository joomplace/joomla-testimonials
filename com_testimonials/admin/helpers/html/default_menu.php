...
<div id="tm-navbar" class="navbar navbar-static navbar-inverse">
    <div class="navbar-inner">
        <div class="container" style="width: auto;">
            <a class="brand" href="<?php JRoute::_('index.php?option=com_testimonials') ?>"><img class="tm-panel-logo" src="<?php echo JURI::root() ?>administrator/components/com_testimonials/assets/images/joomplace-logo.png" /> <?php echo JText::_('COM_TESTIMONIALS_JOOMPLACE')?></a>
            ...
            <div class="nav-collapse-joomlaquiz nav-collapse collapse">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="drop-testimonials-management">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?option=com_categories&extention=com_testimonials"><?php echo JText::_('COM_TESTIMONIALS_CATEGORIES');?></a></li>
