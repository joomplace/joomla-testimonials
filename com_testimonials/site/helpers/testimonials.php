...
class TestimonialsHelper
{
    ...
    public static function notifyAdmin($caption, $author, $isEdited, $id){
        ...
        switch($params->get('enable_email')){
            ...
            case '1':
                ...
                if($isEdited == true){
                    ...
                    $body = file_get_contents(JUri::root().JUri::root(true).'index.php?option=com_testimonials&layout=black&tmpl=component&limit=1&embed=1&anc='.$id);
                }else{
